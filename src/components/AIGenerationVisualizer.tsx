...
const AIGenerationVisualizer: React.FC<AIGenerationVisualizerProps> = ({ isGenerating }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50" style={{ left: 'var(--sidebar-width, 0px)' }}>
      <div className="fixed inset-0 bg-white/50 backdrop-blur-sm" style={{ left: 'var(--sidebar-width, 0px)' }} />
