    ...
    <main className="flex-1 p-6 bg-gray-50 min-h-screen">
      <div className="container mx-auto">
        <div className="flex items-center justify-between mb-2">
          ...
          <h1 className="text-2xl font-bold text-[#1E3D59] ml-4">人材サマリ生成</h1>
        </div>
          ...
          <div className="space-y-8 bg-white p-8 rounded-lg shadow-sm">
            <div>
              <div className="h-[60px] flex items-center">
                <h3 className="text-lg font-medium text-[#1E3D59]">経歴書アップロード</h3>
              </div>
            ...
            <div className="space-y-6">
              <h3 className="text-lg font-medium text-[#1E3D59] mb-4">面談メモ</h3>
              <TextInput 
                label=""
